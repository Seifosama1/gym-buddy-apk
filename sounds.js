...
const SoundManager = (() => {
  ...
  /**
   * Chat message notification — soft double-blip at 520 Hz
   * Distinct from tap (1200), check (880/1320), success (660/880), error (440/330),
   * goalReached (523–1319 arpeggio).  Duration ~250 ms, sits in the 500–550 Hz pocket.
   * Used on: incoming message when chat modal is closed
   */
  function chatMessage() {
    playTone({ frequency: 520, type: 'sine', gain: 0.13, duration: 0.09, attack: 0.004, startTime: 0 });
    playTone({ frequency: 540, type: 'sine', gain: 0.10, duration: 0.09, attack: 0.004, startTime: 0.12 });
  }

  // Public API
  return { tap, check, uncheck, timerTick, timerTickWarn, timerDone, alarmBeep, waterSplash, modalOpen, success, error, goalReached, chatMessage, toggle, isEnabled, init };
})();
